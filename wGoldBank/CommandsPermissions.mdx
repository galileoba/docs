...
| /goldbank help                     | [goldbank.command.help](http://goldbank.command.help)                 | Displays a list of available `/gb` commands along with brief descriptions. Useful for getting quick guidance on how to use the plugin.  |
